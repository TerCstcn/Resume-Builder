...
namespace TUPApp.Controllers
{
    public class ExperiencesController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            //VieData["StudentId"] = new SelectList(_context.Students, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,JobPosition,Year,StudentId")] Experience experience)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,JobPosition,Year,StudentId")] Experience experience)
        {
            if (id != experience.Id)
            {
                return NotFound();
